...
function Alert() {
  ...
  useEffect(() => {
    // console.log(alertCtx.alert.type);
  }, [alertCtx.alert]);
  ...
  return (
    <>
      { alertCtx.alert.type === "info" &&
        ...
        <div>
          <span className="font-medium"></span> {alertCtx.alert.message}
        </div>
      </div>
      }
      { (alertCtx.alert.type === "error" ) &&
        ...
        <span className="sr-only">Info</span>
        <div>
          <span className="font-medium">Error : </span> {alertCtx.alert.message}
        </div>
      </div>
      }
      { alertCtx.alert.type === "success" &&
        ...
        <span className="sr-only">Info</span>
        <div>
          <span className="font-medium">Success : </span> {alertCtx.alert.message}
        </div>
      </div>
      }
      { alertCtx.alert.type === "warning" &&
        ...
        <span className="sr-only">Info</span>
        <div>
          <span className="font-medium">Warning : </span> {alertCtx.alert.message}
        </div>
      </div>
      }
      { alertCtx.alert.type === "dark" &&
        ...
        <span className="sr-only">Info</span>
        <div>
          <span className="font-medium">Info : </span> {alertCtx.alert.message}
        </div>
      </div>
      }
    </>
